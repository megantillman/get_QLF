...
Lleft = 8.95 #change left bound of L
...
#### Reshape the grid.
chi2_grid = np.concatenate(chunk_results).reshape((reso, reso, reso, reso, reso, reso))
...
print(f'\nProccess complete. Output written to "output/chi2_SHEN_r{reso}_6param.h5py".\n')
