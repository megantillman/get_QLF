...
f = h5py.File("output/chi2_3pShenfit_yw.h5py", "w")
...
def chi2(a, z, qlf):
    ...
    return np.sum((ym[ym > ya] - ya[ym > ya])**2 / err_abv[ym > ya]**2) + np.sum((ym[ym < ya] - ya[ym < ya])**2 / err_blw[ym < ya]**2)
...
for z in zlist:
    ...
    f = h5py.File("output/chi2_3pShenfit_yw.h5py", "a")
