...
filename = "/mnt/home/mtillman/ceph/QLF_proj/output/chi2_phantom_2P_Lcap_lowres_z"+str(z)+".h5py"

r1, r2, r3, r4, r5, r6 = 15, 15, 15, 15, 15, 15

logMstar0 = np.linspace(8.0,12.0, r1)
xsigpre = np.linspace(0.1,5.0,r2)
xsigpost = np.linspace(0.1,5.0,r3)
slopes = np.linspace(0.01,4.0,r4)
