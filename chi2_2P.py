...
filename = "/mnt/home/mtillman/ceph/QLF_proj/output/chi2_2P_z"+str(z)+".h5py"

r1, r2, r3, r4, r5, r6 = 25, 25, 25, 21, 25, 25

logMstar0 = np.linspace(8.0,12.0, r1)
xsigpre = np.linspace(0.1,5.0,r2)
xsigpost = np.linspace(0.1,5.0,r3)
slopes = np.linspace(0,2,r4)
slopes[0] = 0.001
...
def chi2(a):
    ...
    dNdlogL = get_QLF(lums, logMstar0 = a[0], slope_low = a[3], norm_from_local = a[4], norm_local = 11+a[5], presig = a[1], postsig = a[2])
