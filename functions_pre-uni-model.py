...
class QLF():
    ...
    def get_SMBM(self, dM = 10.3, Mmid, slope1 = 0.2, slope3 = 1.):
    ...
    def convolve_smhm(self, StellBins, sigma): 
    ...
    def get_dNdMstar(self, smhm_scat):
        ...
        if smhm_scat == 0.:
            ...
            self.dNdMstar = self.convolve_smhm(self.StellBins, smhm_scat)
    ...
    def get_dNdL(self, xsigs, dX, obscured):
        ...
        mean_etas = np.apply_along_axis(self.get_mean_etas, 1, vals)
